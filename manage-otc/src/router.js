...
export const appRouter = [
    ...
    children: [
      {
        ...
        name: 'identityList',
        title: '实名认证管理',
        component: resolve => { require(['./views/operated/identity-list.vue'], resolve); }
      },
      {
        path: 'appeal',
        icon: 'hammer',
        name: 'appeal',
        title: '申述管理',
        component: resolve => { require(['./views/operated/appeal.vue'], resolve); }
      },
      {
        path: 'seller',
        icon: 'android-cart',
        name: 'seller',
        title: '商户管理',
        component: resolve => { require(['./views/operated/seller.vue'], resolve); }
      },
      {
        path: 'withdrawals',
        icon: 'social-bitcoin',
        name: 'withdrawals',
        title: '放币管理',
        component: resolve => { require(['./views/operated/withdrawals.vue'], resolve); }
      },
      {
        path: 'clear',
        icon: 'unlocked',
        name: 'clear',
        title: '清除限制',
        component: resolve => { require(['./views/operated/clear.vue'], resolve); }
      },
      {
        path: 'downloadTran',
        icon: 'arrow-down-a',
        name: 'downloadTran',
        title: '下载未签名交易',
        component: resolve => { require(['./views/operated/download-transaction.vue'], resolve); }
      }/*,
      {
        path: 'exeCurrency',
        icon: 'social-bitcoin',
        name: 'exeCurrency',
        title: '放币处理',
        component: resolve => { require(['./views/operated/exeCurrency.vue'], resolve); }
      },*/
      /*{
        path: 'upload',
        icon: 'image',
        name: 'upload',
        title: '图片上传',
        component: resolve => { require(['./views/operated/upload-pic.vue'], resolve); }
      },
      {
        path: 'release',
        icon: 'flag',
        name: 'release',
        title: '版本管理',
        component: resolve => { require(['./views/operated/release.vue'], resolve); }
      },
      {
        path: 'banner',
        icon: 'images',
        name: 'banner',
        title: 'Banner管理',
        component: resolve => { require(['./views/operated/banner.vue'], resolve); }
      }*/
    ]
  },
  /*{
    ...
    children: [
      {
        ...
        name: 'systemlog',
        title: '系统日志',
        component: resolve => { require(['./views/ops/system-log.vue'], resolve); }
      },
      {
        path: 'requestlog',
        icon: 'bonfire',
        name: 'requestlog',
        title: '请求日志',
        component: resolve => { require(['./views/ops/request-log.vue'], resolve); }
      }
    ]
  },*/
  {
    ...
    children: [
    {
        ...
        name: 'userCount',
        title: '用户渠道统计',
        component: resolve => { require(['./views/system/userCount.vue'], resolve); }
      },
        {
            path: 'application',
            icon: 'ios-cog',
            name: 'application',
            title: '应用管理',
            component: resolve => { require(['./views/system/application.vue'], resolve); }
        },
        {
            path: 'applicationclient',
            icon: 'ios-color-filter-outline',
            name: 'applicationclient',
            title: '应用客户端',
            component: resolve => { require(['./views/system/application-client.vue'], resolve); }
        },
       {
        path: 'user',
        icon: 'ios-people',
  ...
  //               name: 'qa',
  //               title: '问答管理',
  //               component: resolve => { require(['./views/qa/qa.vue'], resolve); }
  //           },
  //           {
  //               path: 'test',
  //               icon: 'compose',
  //               name: 'test',
  //               title: '问答管理',
  //               component: resolve => { require(['./views/qa/test.vue'], resolve); }
  //           }
  //       ]
  //   },
  //   {
