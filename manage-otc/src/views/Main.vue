...
<template>
    <div class="main" :class="{'main-hide-text': hideMenuText}">
        <div class="sidebar-menu-con" :style="{width: hideMenuText?'60px':'200px', overflow: hideMenuText ? 'visible' : 'auto', background: $store.state.menuTheme === 'dark'?'#495060':'white'}">
            <div class="logo-con">
                <img v-show="hideMenuText" src="../assets/img/normal/logo-min.jpg" key="min-logo" />
                <div v-show="!hideMenuText" style="width: 170px;height: 44px;background:#2d8cf0 ;color: #FFFFFF;font-size: 22px;border-radius: 5px;line-height: 44px;">币 探 OTC</div>
            </div>
