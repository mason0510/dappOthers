 ...
 */
public class FuturesStrategyDto implements Serializable {
    ...
    public FuturesStrategyDto(){};

    public FuturesStrategyDto(Long id, Long userId, String userName, String biCode, BigDecimal buyPriceOrder, BigDecimal buyPriceDeal, BigDecimal sellPriceDeal, BigDecimal contractValue, Integer amount, Integer type, Integer status, Integer mold, String direction, BigDecimal principal, BigDecimal gainPrice, BigDecimal lossPrice, BigDecimal closePrice, BigDecimal serviceCharge, BigDecimal deferCharge, Integer isDefer, Integer isToday, String closeReason, String cancelReason, Date buyDealTime, Date buyOrderTime, Date sellDealTime, Date cancelTime, String remark, Date version) {
        this.id = id;
        this.userId = userId;
